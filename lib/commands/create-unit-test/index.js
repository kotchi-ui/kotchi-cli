...
function createUnitTest(_x) {
  return _createUnitTest.apply(this, arguments);
}

function _createUnitTest() {
  _createUnitTest = _asyncToGenerator(
        ...
        while (1) {
          switch ((_context.prev = _context.next)) {
            case 0:
              ...
              resourceTemplatePath = "_test.js.template";
              resourceOutputPath = ""
                .concat(targetComponentPath)
                .concat(path.sep);
              resourceOutputFileName = "_test.js";
